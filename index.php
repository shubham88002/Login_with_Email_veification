    ...
    <nav class="navbar navbar-light bg-light static-top">
        <div class="container">
            ...
            <div class="nav-link">
                ...
                <a href="login.php" class="btn btn-primary" data-bs-target="#Login">Login</a>
                <a class="btn btn-primary" href="register.php" data-bs-target="#Signup">Sign Up</a>
            </div>
                        ...
                        <form action="" method="POST">
                            <form class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="phone" id="validationCustom06" value="" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control" name="confirm-password" id="validationDefaultpass" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                </div>
                                <div class="col-12">
